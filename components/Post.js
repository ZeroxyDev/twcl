      ...
      <div className="flex flex-col md:max-w-[800px]">
        <div className={`flex ${!postPage && "justify-between max-w-[700px] pl-[55px] -mt-12 mb-6"}`}>
          ...
          <div className="text-[#6e767d]">
            ...
            {!postPage && (
              <p className="text-[#d9d9d9] text-[15px] sm:text-base mt-0.5 -mb-4 lg:-mb-8 max-w-lg overflow-auto break-words">
                {post?.text}
              </p>
            )}
          </div>
        ...
        {postPage && (
          <p className="text-[#d9d9d9] ml-4 mr-4 mt-2 mb-3 md:mr-4 lg:mr-4 sm:ml-4 text-xl sm:mt-3 max-w-lg overflow-auto break-words">{post?.text}</p>
        )}
        <img  
          src={post?.image}
          alt=""
