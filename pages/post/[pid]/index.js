...
import { modalState, modalcState, postIdState } from "../../../atoms/modalAtom";
...
function PostPage({ trendingResults, followResults, providers, articles, id }) {
    ...
    <div>
      ...
      <main className="bg-black min-h-[100vh] flex max-w-[1402px] mx-auto">
        ...
        <div className="flex-grow border-l border-r border-gray-700 max-w-2x1 sm:ml-[73px] xl:ml-[370px]">
          ...
          <Post id={pid} post={post} postPage />
          {comments.length > 0 && (
            <div className="pb-72">
