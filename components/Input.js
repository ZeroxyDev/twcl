        ...
        <div className={`${selectedFile && "pb-7"} ${input && "space-y-2.5"}`}>
          ...
          <div className="flex items-center justify-between pt-2.5 mt-4">
            <div className="flex items-center">
              ...
              >
                <PhotographIcon className="text-[#b1b1b1] h-[22px]" />
                <input
                  type="file"
                  ref={filePickerRef}
                  hidden
              ...
              <div className="icon rotate-90">
                <ChartBarIcon className="text-[#b1b1b1] h-[22px]" />
              </div>

              <div className="icon" onClick={() => setShowEmojis(!showEmojis)}>
                <EmojiHappyIcon className="text-[#b1b1b1] h-[22px]" />
              </div>

              <div className="icon">
                <CalendarIcon className="text-[#b1b1b1] h-[22px]" />
              </div>
